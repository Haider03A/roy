...
import { AddSaleButton } from "./components/AddSaleBut";
import { DeleteSaleBut } from "./components/DeleteSaleBut";

export const ModifyInvoice = () => {
    const saleListRef = useRef(null)
    const saleNodeRef = useRef(null)
    const [saleNodeActive, setSaleNodeActive] = useState(null)
        ...
        <>
            <PopUpTemp>
                <div className="container py-5 bg-white rounded-lg">
                    <h1 className="pb-2 mb-2 border-b font-semibold">Modify invoice</h1>
                    {
                                            ...
                                            (formik) => {
                                                return (
                                                    ...
                                                    <Form className="flex flex-col gap-y-2"
                                                        ...
                                                        <div className='h-20 py-1 pb-4 flex justify-between items-center'>
                                                        ...
                                                        <ul className="snap-mandatory snap-x overflow-x-scroll flex gap-x-3 pb-4 px-1 pt-1">
                                                            <FieldArray
                                                                name="sales"
                                                                render={arrayHelpers => (
                                                                    formik.values.sales.map((sale, index) => {
                                                                        return (
                                                                            <li key={sale.saleId}
                                                                                ref={saleListRef}
                                                                                className="min-w-full snap-center snap-always bg-white p-2 text-gray-600 rounded-lg shadow ">
                                                                                <div className="flex justify-between">
                                                                                    <span className='text-gray-500'>#{sale.saleId}</span>
                                                                                    <DeleteSaleBut saleId={sale.saleId} />
                                                                                </div>
                                                                                <div className="flex gap-3 flex-wrap">
                                                                                    ...
                                                                                    <div className="flex flex-col basis-full">
                                                                                        ...
                                                                                        {
                                                                                            sale.saleId === saleNodeActive || sale.saleNote ?
                                                                                                ...
                                                                                                <textarea type="text"
                                                                                                    ...
                                                                                                    onChange={formik.handleChange}
                                                                                                    onFocus={(e) => e.target.select()}
                                                                                                    onBlur={() => setSaleNodeActive(null)} />
                                                                                                :
                                                                                                <button type="button"
                                                                                                    className="w-full h-16 px-2 py-1 bg-white shadow rounded-lg"
                                                                                                    id={`sales.${index}.saleNote`}
                                                                                                    onClick={() => setSaleNodeActive(sale.saleId)}>Write node</button>
                                                                                        }
                                                                                    </div>
                                                        ...
                                                        <div className="mt-4 flex gap-x-3 justify-between">
