...
export const CreateInvoiceBut = () => {
    const navigate = useNavigate();

    return (
        <div className="h-[75px] py-3 flex justify-center items-center bg-white">
            <button type="button" className='h-full w-full flex justify-center items-center bg-sky-500 active:bg-sky-600 text-center rounded-lg'
