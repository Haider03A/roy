...
import { MainButton } from '../../components/templatesComp/MainButton';
                            ...
                            <li key={invoice.invoiceId}
                                    ...
                                    <div className='h-full flex flex-col justify-between items-center text-sm'>
                                        <span>
                                            {new Intl.DateTimeFormat("en-IQ", {
                                                ...
                                                day: 'numeric',
                                                weekday: 'short',
                                            }).format(invoice.invoiceCreatedTime)}
                                        </span>
                                ...
                                <div className='h-14 py-1 flex justify-between items-center'>
                                    <div className='flex flex-col justify-between'>
                                        <div>
                                            <span>Price: </span>
                                            <span className='font-semibold'>{invoice.invoicePrice}</span>
                                            <span className='text-xs'> IQD</span>
                                        </div>
                                        <div>
                                            <span>Cost: </span>
                                            <span className='font-semibold'>{invoice.invoiceCost}</span>
                                            <span className='text-xs'> IQD</span>
                                        </div>
                                    </div>
